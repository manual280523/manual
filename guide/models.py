...
class Teststask(models.Model):
    category = models.ForeignKey(Category, related_name='category_teststask', on_delete=models.CASCADE)
...
class Question(models.Model):
    teststask = models.ForeignKey(Teststask, related_name='teststask_questions', on_delete=models.CASCADE)
...
class Protocol(models.Model):
    teststask = models.ForeignKey(Teststask, related_name='teststask_protocol', on_delete=models.CASCADE)
...
class Decision(models.Model):
    dated = models.DateTimeField(_('dated'), auto_now_add=True)
    user = models.ForeignKey(User, related_name='decision_user', on_delete=models.CASCADE)
    title = models.CharField(_('task_title'), max_length=255)
    solution = models.TextField(_('solution'))
    rating = models.TextField(_('rating'), blank=True, null=True)    
    class Meta:
        # Параметры модели
        # Переопределение имени таблицы
        db_table = 'decision'
